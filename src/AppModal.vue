...
const finalScore = computed(() => {
  return score.score - (1000 - score.capital)*2 - score.numberOfDeaths * 1000;
});
</script>
...
<template>
  <div class="h-screen w-screen z-10 absolute flex items-center justify-center">
    ...
    <div class="w-[250px] border rounded-md p-4 z-20 space-y-1">
      <h1 class="text-2xl text-center font-bold">Game Over</h1>
    ...
    <h1 class="text-2xl text-center font-bold">Your score is: {{ finalScore }}</h1>
